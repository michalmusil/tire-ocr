...
using AiPipeline.TireOcr.DbMatcher.Application.Queries.GetDbMatchesForCodeAndManufacturer;
using AiPipeline.TireOcr.DbMatcher.WebApi.Contracts.GetMatchesInTireDb;
using Asp.Versioning;
using MediatR;
using Microsoft.AspNetCore.Mvc;
using TireOcr.Shared.Result;

namespace AiPipeline.TireOcr.DbMatcher.WebApi.Controllers;
