...
public class PreprocessingAbsoluteRoiProcessor : IPreprocessingProcessor
{
    private readonly HttpClient _remoteProcessorClient;
    private readonly ILogger<PreprocessingRoiExtractionProcessor> _logger;

    public PreprocessingAbsoluteRoiProcessor(HttpClient remoteProcessorClient,
        ...
        PreprocessingType preprocessingType)
    {
        try
        {
            ...
            var res = await _remoteProcessorClient.PostAsync("/api/v1/Preprocess/ExtractAbsoluteRoi", content);
